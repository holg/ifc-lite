...
impl Mesh {
    ...
    /// Convert to ifc-lite-model MeshData format
    pub fn to_mesh_data(&self) -> ifc_lite_model::MeshData {
        ifc_lite_model::MeshData {
    ...
    /// Create from ifc-lite-model MeshData format
    pub fn from_mesh_data(data: &ifc_lite_model::MeshData) -> Self {
        Self {
